...
- (void)addParallaxWithImage:(UIImage *)image andHeight:(CGFloat)height andShadow:(BOOL)shadow {
    ...
    {
        APParallaxView *parallaxView = [[APParallaxView alloc] initWithFrame:CGRectMake(0, 0, sWidth * 2, height) andShadow:shadow];
...
- (void)addParallaxWithView:(UIView*)view andHeight:(CGFloat)height {
    ...
    {
        APParallaxView *parallaxView = [[APParallaxView alloc] initWithFrame:CGRectMake(0, 0, sWidth, height)];
        [parallaxView setClipsToBounds:YES];
...
- (void)drawRect:(CGRect)rect {
    ...
    //// Rectangle Drawing
    UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRect: CGRectMake(0, 0, CGRectGetWidth(rect), 40)];
