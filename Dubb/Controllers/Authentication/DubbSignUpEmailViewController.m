...
#define REGEX_USER_NAME_LIMIT @"^.{5,15}$"
#define REGEX_USER_NAME @"[A-Za-z0-9_]{5,15}"
...
-(void) setupUI
{
    ...
    [txtUsername addRegx:REGEX_USER_NAME_LIMIT withMsg:@"User name needs to be between 5 and 15 characters"];
